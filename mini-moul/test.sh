...
print_header() {
  space
  printf "\033[38;2;241;242;181m%s${DEFAULT}\n" " ███▄ ▄███▓ ██▓ ███▄    █  ██▓"
  printf "\033[38;2;213;226;170m%s${DEFAULT}\n" "▓██▒▀█▀ ██▒▓██▒ ██ ▀█   █ ▓██▒"
  printf "\033[38;2;186;202;158m%s${DEFAULT}\n" "▓██    ▓██░▒██▒▓██  ▀█ ██▒▒██▒"
  printf "\033[38;2;158;178;147m%s${DEFAULT}\n" "▒██    ▒██ ░██░▓██▒  ▐▌██▒░██░"
  printf "\033[38;2;130;153;135m%s${DEFAULT}\n" "▒██▒   ░██▒░██░▒██░   ▓██░░██░"
  printf "\033[38;2;102;129;124m%s${DEFAULT}\n" "░ ▒░   ░  ░░▓  ░ ▒░   ▒ ▒ ░▓  "
  printf "\033[38;2;75;105;112m%s${DEFAULT}\n" "░  ░      ░ ▒ ░░ ░░   ░ ▒░ ▒ ░"
  printf "\033[38;2;47;81;101m%s${DEFAULT}\n" "░      ░    ▒ ░   ░   ░ ░  ▒ ░"
  printf "\033[38;2;19;80;88m%s${DEFAULT}\n" "       ░    ░           ░  ░  "
